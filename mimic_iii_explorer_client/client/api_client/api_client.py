...
from api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ClinicalTextApi()
        api_instance.clinical_text  # this is an instance of the class Endpoint
        api_instance.clinical_text()  # this invokes api_instance.clinical_text.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.clinical_text.callable or self.callable in this class
