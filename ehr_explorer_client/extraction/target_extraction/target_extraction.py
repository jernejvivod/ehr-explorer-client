...
from ehr_explorer_client.client.target_api_client import TargetApiClient
...
def extract_target(target_extraction_spec: TargetExtractionSpec) -> List[ExtractedTarget]:
    ...
    """
    logger.info('Requesting ehr-explorer to extract the target values for the specified ids')
