...
from ehr_explorer_client import CONFIG_EHR_EXPLORER_CORE_SECTION, CONFIG_EHR_EXPLORER_CORE_URL_KEY, CONFIG_PATH


class AbstractCoreApiClient(ABC):
    def __init__(self, config_path: str = None):
        ...
        self.client_config = generated_client.Configuration(
            host=config[CONFIG_EHR_EXPLORER_CORE_SECTION][CONFIG_EHR_EXPLORER_CORE_URL_KEY],
        )
